...
import { Calendar, CalendarEvent, CalendarEventEditMode, CalendarSettings, CalendarWeekday } from 'app/modules/calendar/calendar.types';
...
export class CalendarService
{
    ...
    get events$(): Observable<CalendarEvent[]>
    {
        ...
        //this.getFromDatabase().subscribe((res)=>{
        //    console.log("mel service :::::::,",res);
//});
        return this._events.asObservable();
    }
        ...
        return this.calendars$.pipe(
            ...
            switchMap(calendars => this._httpClient.delete<Calendar>('api/apps/calendar/calendars', {
                ...
                map((isDeleted) => {
                    ...
                    const events = this._events.value.filter(event => event.id !== id);
